 ...
 */
class ZeroY_API_Routes_Fonts extends ZeroY_API_Routes_Base {
    ...
    public function get_font_settings($request) {
        $settings = ZeroY_Font_Manager_Service::get_font_settings();
    ...
    public function update_font_settings($request) {
        ...
        $result = ZeroY_Font_Manager_Service::update_font_settings($settings);
    ...
    public function clear_font_cache($request) {
        ZeroY_Font_Manager_Service::clear_font_cache();
