...
class ZeroY_Admin_Bar_Notice
{
    ...
    {
        return (bool) get_option('zeroy_speed_optimization_enabled', false);
    }
    ...
    public static function add_admin_bar_item($wp_admin_bar)
    {
        ...
        // 获取设置页面链接
        $settings_url = admin_url('admin.php?page=zeroy#performance');
        ...
        $wp_admin_bar->add_node([
            ...
            'href' => $settings_url,
            'meta' => [
                'class' => 'zeroy-dev-mode-notice',
                'title' => 'zeroy 自动速度优化未开启，点击前往设置'
            ]
        ]);
    }
    ...
    public static function add_admin_bar_styles()
    {
        ...
        ?>
        <style>
            #wp-admin-bar-zeroy-notice>.ab-item {
                background-color: #dc3545 !important;
                color: white !important;
                font-weight: 500 !important;
            }

            #wp-admin-bar-zeroy-notice:hover>.ab-item {
                background-color: #c82333 !important;
                color: white !important;
            }

            #wp-admin-bar-zeroy-notice .ab-item:before {
