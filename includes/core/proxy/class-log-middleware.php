 ...
 */
class Aether_Proxy_Log_Middleware implements Aether_Proxy_Middleware {
    ...
    private function log_request($request) {
        ...
        error_log('[Aether Proxy] Request: ' . json_encode($log_data));
    }
    ...
    private function log_response($request, $response, $duration) {
        ...
        error_log('[Aether Proxy] Response: ' . json_encode($log_data));
    }
