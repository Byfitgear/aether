<?php
/**
 * Category Template - Specific category archives
 * 
 * @package Aether
 */
...
/**
 * Class Aether_Template_Category
 */
class Aether_Template_Category {
    ...
    public static function get() {
        ...
        <div class="min-h-screen">
            <header class="mb-8 pb-4 border-b border-gray-300">
                <h1 class="text-3xl font-bold mb-4">分类: <?php single_cat_title(); ?></h1>
            ...
            <?php else : ?>
                <div class="text-center py-16">
                    <h2 class="text-2xl font-bold mb-4">该分类暂无文章</h2>
                    <p class="text-gray-600">此分类下还没有发布任何文章。</p>
                </div>
            <?php endif; ?>
        </div>
        ';
