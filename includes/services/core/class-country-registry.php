 ...
 * Country Registry
 *
 * Canonical ISO 3166-1 alpha-2 country code mapping used by geo resolution.
 */

defined('ABSPATH') || exit;

class Aether_Country_Registry
{
    /**
     ...
     * @return string
     */
    public static function normalize_country_code($country_code)
    {
