...
/**
 * Class Aether_Template_Override
 */
class Aether_Template_Override extends Aether_Base
{
	...
	{
		$this->template_path = AETHER_PATH . 'templates/';
	...
	private function get_custom_template_path()
	{
		...
		return $this->template_path . 'aether-universal-template.php';
	}
	...
	{
		// 注册自定义模板标签，供模板文件使用
		if (!function_exists('aether_header')) {
			function aether_header()
			{
				$templates = Aether_Templates::getInstance();
				$template_service = Aether_Template_Service::getInstance();
				$header_template = $templates->get_active_template('header');
		...
		if (!function_exists('aether_footer')) {
			function aether_footer()
			{
				$templates = Aether_Templates::getInstance();
				$template_service = Aether_Template_Service::getInstance();
				$footer_template = $templates->get_active_template('footer');
		...
		if (!function_exists('aether_content')) {
			function aether_content()
			{
				$templates = Aether_Templates::getInstance();
				$template_service = Aether_Template_Service::getInstance();
				$template_types = Aether_Dynamic_Template_Types::getInstance();
		...
		if (!function_exists('aether_should_exclude_header_footer')) {
			function aether_should_exclude_header_footer()
			{
				$template_override = Aether_Template_Override::getInstance();
